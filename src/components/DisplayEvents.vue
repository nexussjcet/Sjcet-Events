...
.events-header {
  margin-top: 80px; /* Add margin top to push the title down */
  font-size: 2.5rem;
}

.search-container {
  margin-top: 20px; /* Adjust space between title and search bar */
}

.search-container input {
  background-color: rgba(0, 0, 0, 0.8); /* Dark background for input */
  color: #BABABA; /* Light gray text for input */
  border: 2px solid #1A1A1A; /* Matches dark theme */
  border-radius: 8px;
  padding: 10px;
  width: 300px;
...
.event-card {
  ...
  color: #BABABA; /* Light text for readability */
  border: 2px solid #D4AF37; /* Gold border for cards */
  margin: 10px;
  width: 300px;
  height: 350px;
  padding: 16px;
...
.event-card:hover {
  box-shadow: 0 10px 15px rgba(0, 0, 0, 0.4); /* Subtle shadow */
  transform: translateY(-5px);
}

.card-header {
  margin-bottom: 12px; /* Slightly larger margin for separation */
  display: flex;
  flex-direction: column;
}
...
.card-title {
  ...
  margin-bottom: 12px; /* Reduced space below the title */
  align-self: center; /* Center align the title */
  margin-top: 10px; /* Adjust space above the title */
}
...
.card-footer {
  position: absolute;
  bottom: 16px; /* Position the footer at the bottom */
  left: 16px;
  right: 16px;
  display: flex;
...
.regfee {
  color: #D4AF37; /* Gold color for reg fee */
}

.dates-container {
  margin-top: 10px; /* Reduced margin to raise the dates section */
  flex-grow: 0; /* Prevent it from growing */
}

.auth-btn {
  background-color: rgba(26, 26, 26, 0.9); /* Matches theme */
  color: #D4AF37; /* Gold text */
